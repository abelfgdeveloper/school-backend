...
class DeleteStudentByIdUseCaseImplTest extends CommonApiTest {
  ...
  void test_delete_ok() throws Exception {
    ...
    Optional<StudentEntity> studentInDataBase = studentSpringDataJpaRepository.findById(id);
    assertFalse(studentInDataBase.isPresent());
  }
